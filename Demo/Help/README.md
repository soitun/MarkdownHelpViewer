...
The integration was tested from **Delphi XE6** to **Delphi 13**: for older versions of Delphi please give a request into ["Issue section"](https://github.com/EtheaDev/MarkdownHelpViewer/issues)
